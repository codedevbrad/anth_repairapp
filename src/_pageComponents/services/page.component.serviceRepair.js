...
export default function ComponentServiceRepair({ title = 'set title' , showTitle = true }) {
  return (
    <div className="p-6">
                  ...
                  <div>
                    ...
                    <div>
                        <div className="group block w-full aspect-w-10 aspect-h-7 rounded-lg focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-100 overflow-hidden">
                              <img src={ work.images.repair } alt="" className="object-cover pointer-events-none group-hover:opacity-75" />
                          </div>
                    </div>
        </div>
    </div> 
